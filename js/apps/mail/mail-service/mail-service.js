...
function randName() {
    var names = ['Yosi', 'Avi', 'Dana', 'Roni', 'Roy', 'Dan', 'Rami', 'Ran', 'Idan', 'Rotem', 'Ori', 'Itay', 'Tal', 'Hadas', 'Smadar', 'Liran', 'Gili', 'Michal'];
    var num = utilService.getRandomIntInclusive(0, 17);
    var name = names[num]
    return name
}